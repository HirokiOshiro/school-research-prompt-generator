...
学校調査プロンプト生成ツール - 留学生入試担当職員向け

## 概要

留学生向け入試において、志願者の出身高校情報を調査するための生成AI用プロンプトを簡単に生成できるWebツールです。
...
`js/country-data.js` を編集して、各国・地域の教育情報を更新できます。
...
| 日付 | バージョン | 内容 |
|------|---------|------|
| 2026/01/31 | v0.1 | Phase 1 完了（中国・韓国・ベトナム） |
| 2026/01/31 | v0.2 | Phase 2 完了（10カ国・地域対応） |
| 2026/01/31 | v1.0 | Phase 3 完了（UI改善・バイリンガル・確認機能・表記修正） |
